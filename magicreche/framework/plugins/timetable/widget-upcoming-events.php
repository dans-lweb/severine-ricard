...
class upcoming_events_widget extends WP_Widget 
{
    ...
    function upcoming_events_widget() 
	{
        ...
        parent::WP_Widget('timetable_upcoming_events', __('Upcoming Events', 'timetable'), $widget_options);
    }
    ...
    function widget($args, $instance) 
	{
		...
		if($display_settings=="all")
		{
			...
			$weekdays_orders_array = array_unique($weekdays_orders_array);
		...
		//t3.post_type='timetable_weekdays' AND t2.ID='" . $post->ID . "'";
